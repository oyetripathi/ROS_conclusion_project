...
if("TRUE" STREQUAL "TRUE")
  set(openslam_gmapping_SOURCE_PREFIX /home/sandeepan/tiago_public_ws/src/openslam_gmapping)
  set(openslam_gmapping_DEVEL_PREFIX /home/sandeepan/tiago_public_ws/devel/.private/openslam_gmapping)
  ...
  set(openslam_gmapping_INSTALL_PREFIX /home/sandeepan/tiago_public_ws/install)
...
if(NOT "/home/sandeepan/tiago_public_ws/src/openslam_gmapping/include " STREQUAL " ")
  set(openslam_gmapping_INCLUDE_DIRS "")
  set(_include_dirs "/home/sandeepan/tiago_public_ws/src/openslam_gmapping/include")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'openslam_gmapping' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/sandeepan/tiago_public_ws/src/openslam_gmapping/${idir}'.  ${_report}")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/sandeepan/tiago_public_ws/devel/.private/openslam_gmapping/lib;/home/sandeepan/tiago_public_ws/devel/lib;/opt/ros/melodic/lib)
