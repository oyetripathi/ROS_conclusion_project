...
//#line 291 "/opt/ros/melodic/lib/python2.7/dist-packages/dynamic_reconfigure/parameter_generator_catkin.py"
      Default.abstract_parameters.push_back(segmentConfig::AbstractParamDescriptionConstPtr(new segmentConfig::ParamDescription<int>("method", "int", 0, "A PointCloud2 origin param which is edited via an enum", "{'enum_description': 'An enum to choose method', 'enum': [{'srcline': 20, 'description': 'Plane', 'srcfile': '/home/sandeepan/tiago_public_ws/src/tiago_tutorials/tiago_pcl_tutorial/cfg/segment.cfg', 'cconsttype': 'const int', 'value': 0, 'ctype': 'int', 'type': 'int', 'name': 'Plane'}, {'srcline': 21, 'description': 'Cylindrical', 'srcfile': '/home/sandeepan/tiago_public_ws/src/tiago_tutorials/tiago_pcl_tutorial/cfg/segment.cfg', 'cconsttype': 'const int', 'value': 1, 'ctype': 'int', 'type': 'int', 'name': 'Cylindrical'}, {'srcline': 22, 'description': 'Euclidean', 'srcfile': '/home/sandeepan/tiago_public_ws/src/tiago_tutorials/tiago_pcl_tutorial/cfg/segment.cfg', 'cconsttype': 'const int', 'value': 2, 'ctype': 'int', 'type': 'int', 'name': 'Euclidean'}]}", &segmentConfig::method)));
//#line 291 "/opt/ros/melodic/lib/python2.7/dist-packages/dynamic_reconfigure/parameter_generator_catkin.py"
      __param_descriptions__.push_back(segmentConfig::AbstractParamDescriptionConstPtr(new segmentConfig::ParamDescription<int>("method", "int", 0, "A PointCloud2 origin param which is edited via an enum", "{'enum_description': 'An enum to choose method', 'enum': [{'srcline': 20, 'description': 'Plane', 'srcfile': '/home/sandeepan/tiago_public_ws/src/tiago_tutorials/tiago_pcl_tutorial/cfg/segment.cfg', 'cconsttype': 'const int', 'value': 0, 'ctype': 'int', 'type': 'int', 'name': 'Plane'}, {'srcline': 21, 'description': 'Cylindrical', 'srcfile': '/home/sandeepan/tiago_public_ws/src/tiago_tutorials/tiago_pcl_tutorial/cfg/segment.cfg', 'cconsttype': 'const int', 'value': 1, 'ctype': 'int', 'type': 'int', 'name': 'Cylindrical'}, {'srcline': 22, 'description': 'Euclidean', 'srcfile': '/home/sandeepan/tiago_public_ws/src/tiago_tutorials/tiago_pcl_tutorial/cfg/segment.cfg', 'cconsttype': 'const int', 'value': 2, 'ctype': 'int', 'type': 'int', 'name': 'Euclidean'}]}", &segmentConfig::method)));
...
//#line 15 "/home/sandeepan/tiago_public_ws/src/tiago_tutorials/tiago_pcl_tutorial/cfg/segment.cfg"
      const int segment_original_image = 0;
//#line 16 "/home/sandeepan/tiago_public_ws/src/tiago_tutorials/tiago_pcl_tutorial/cfg/segment.cfg"
      const int segment_filtered_image = 1;
//#line 20 "/home/sandeepan/tiago_public_ws/src/tiago_tutorials/tiago_pcl_tutorial/cfg/segment.cfg"
      const int segment_Plane = 0;
//#line 21 "/home/sandeepan/tiago_public_ws/src/tiago_tutorials/tiago_pcl_tutorial/cfg/segment.cfg"
      const int segment_Cylindrical = 1;
//#line 22 "/home/sandeepan/tiago_public_ws/src/tiago_tutorials/tiago_pcl_tutorial/cfg/segment.cfg"
